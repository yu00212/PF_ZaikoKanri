  ...
  <form method = "post" action = "user_edit_check.php">
    ...
    <p>
      <label for = "name">
        ...
        <input type = "text" name = "name" id = "name" style = "width:200px" value = "{$user_name}" required>
      </label>
    </p>
    ...
    <p>
      <label for = "email">
        ...
        <input type = "email" name = "email" id = "email" style = "width:200px" value = "{$user_email}" required>
      </label>
    </p>
